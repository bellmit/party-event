	...
	var opts = {
            ...
            tableColumn: {
                ...
                columns: [
                    ...
                    {field: 'ADDRESS', label: '压力', className: "unsortable",
                    	tableTransFunc:function(value,item){
							return "正常";
					    }	},
                    {field: 'ADDRESS', label: '水带', className: "unsortable",tableTransFunc:function(value,item){
						return "正常";
				    }},
                    ...
                    },{field: 'DEVICE_CODE', label: '设备编号', className: "unsortable", 
