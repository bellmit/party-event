	...
	dojo.declare(
			...
			esri.layers.TiledMapServiceLayer,
			{
				constructor: function(){
					...
					this.tileInfo = new esri.layers.TileInfo({ 
			            ...
			            "lods" : [ 
			              ...
			              {"level" : 19, "resolution" : 0.2985821417799085, "scale" : 1128.4971765}*/
			            ] 
			          });
				...
				getTileUrl: function(level, row, col){
					var url = "http://webst03.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&" + 
					"x=" + col + "&" +
					"y=" + row + "&" +
					"z=" + level;
					return url;
