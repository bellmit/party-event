...
<script>
	...
	var ulynlistPath = {
		...
		url : '<c:url value="/emergency/emergency_list.do"/>',
		typelist:[]
	}
	var config = {
		...
		<div class="cb-content" <%-- <c:if test="${visiteditem eq 'hide'}"> --%>style="margin-left: 0px"<%-- </c:if> --%>>
			<div class="content">
				<div class="mainContent" style="top: 0px">
					<div class="mcBox">
						<jsp:include page="../include/emergencySearch.jsp"></jsp:include>
						<div class="dwBottom">
...
<script src="<c:url value="/js/page_js/emergency.js"/>"></script>
