...
public class Sign {
    ...
    public static String getRes(String jsapi_ticket,String url,String appId){
    	Map<String, String> ret = sign(jsapi_ticket, url);
    	JSONObject object = new JSONObject();
    	object.put("appId", appId);
    	object.put("timestamp", ret.get("timestamp"));
    	object.put("nonceStr", ret.get("nonceStr"));
    	object.put("signature", ret.get("signature"));
