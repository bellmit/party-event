...
//                    System.err.println("jar类型的扫描");
                                ...
                                if ((idx != -1) || recursive) {
                                    ...
                                    if (name.endsWith(".class")
                                        ...
                                        String className = name.substring(
                                                ...
                                                .length() - 6);
                                        addClassToList(className, packageName, classes, classFilter);
                                    }
                                }
                            }
                        }
    ...
    public static void findAndAddClassesInPackageByFile(String packageName,
                                                        String packagePath, final boolean recursive, List<Class> classes, ClassFilter classFilter) {
        // 获取此包的目录 建立一个File
    ...
    private static void addClassToList(String className, String packageName, List<Class> classes, ClassFilter classFilter) {
        try {
            // 添加到集合中去
